...
// let animationInterval; // Variable to store interval for animation control
...
//   // Fetch the vehicle route data and setup button controls
//   fetchVehicleData();
// }
...
//       // Setup button event listeners for start and stop
...
//   isAnimating = false;
//   clearInterval(animationInterval); // Stop the current animation interval
// }
...
//     if (step === stepCount) {
//       clearInterval(animationInterval);
//       currentIndex++; // Update currentIndex for next segment
